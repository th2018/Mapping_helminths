...
```{r}
for_z<-read.csv("/Users/owner/Desktop/Mapping_helminths-master/Zooscore_trait_Helminth_201904.csv",header=T,sep=',')
head(for_z)
...
```{r}
helminth_country<-unique(l[,c("Parasite","Location")])
save(helminth_country,file="helminth_country.Rdata")
